...
vae_approx_filenames = [
    ('xlvaeapp.pth', 'https://huggingface.co/oieieio/misc/resolve/main/xlvaeapp.pth'),
    ('vaeapp_sd15.pth', 'https://huggingface.co/oieieio/misc/resolve/main/vaeapp_sd15.pt'),
...
def download_models(default_model, previous_default_models, checkpoint_downloads, embeddings_downloads, lora_downloads, vae_downloads):
    ...
    load_file_from_url(
        url='https://huggingface.co/oieieio/misc/resolve/main/fooocus_expansion.bin',
